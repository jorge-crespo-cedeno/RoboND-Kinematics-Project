...
[[ cos(theta<sub>i</sub>) &nbsp &nbsp &nbsp -sin(theta<sub>i</sub>) &nbsp &nbsp &nbsp 0 &nbsp &nbsp &nbsp a<sub>i-1</sub> ]<br>
&nbsp[sin(theta<sub>i</sub>)cos(alpha<sub>i-1</sub>) &nbsp &nbsp &nbsp cos(theta<sub>i</sub>)cos(alpha<sub>i-1</sub>) &nbsp &nbsp &nbsp -sin(alpha<sub>i-1</sub>) &nbsp &nbsp &nbsp -sin(alpha<sub>i-1</sub>)d<sub>i</sub>]<br>
&nbsp[sin(theta<sub>i</sub>)sin(alpha<sub>i-1</sub>) &nbsp &nbsp &nbsp cos(theta<sub>i</sub>)sin(alpha<sub>i-1</sub>) &nbsp &nbsp &nbsp cos(alpha<sub>i-1</sub>) &nbsp &nbsp &nbsp cos(alpha<sub>i-1</sub>)d<sub>i</sub>]<br>
&nbsp[  0  0  0  1  ]]<br>

The homogeneous transformation matrix from base the end-effector is obtained by (<sup>0</sup>T<sub>ee</sub>) = (<sup>0</sup>T<sub>1</sub>)(<sup>1</sup>T<sub>2</sub>)(<sup>2</sup>T<sub>3</sub>)(<sup>3</sup>T<sub>4</sub>)(<sup>4</sup>T<sub>5</sub>)(<sup>5</sup>T<sub>6</sub>)(<sup>6</sup>T<sub>7</sub>)
